...
# Эксперимент D: Кросс-валидация с UNet и предвар

ительно обученным энкодером ResNet18
...
## Результаты
Производительность модели оценивалась с помощью метрики IoU на тестовом наборе данных. Ниже приведены результаты по эпохам для каждого фолда:
