...
avg_val_iou_scores = np.mean(all_val_iou_scores, axis=0)

epochs = range(1, num_epochs + 1)
plt.figure(figsize=(10, 5))
plt.subplot(1, 2, 1)
plt.plot(epochs, avg_train_losses, 'r', label='Train Loss')
plt.title('Training loss')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
plt.subplot(1, 2, 2)
plt.plot(epochs, avg_val_iou_scores, 'b', label='Validation IoU')
